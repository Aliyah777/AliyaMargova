...
public class EmployeeWebTablesPage extends BasePage{
...
public WebElement submitBtn;
    ...
    public EmployeeWebTablesPage addNewEmployee(EmployeeEntity employeeEntity) {
...
// Перебираем каждого сотрудника через цикл
    ...
    public EmployeeWebTablesPage editEmployeeData(String email, EmployeeEntity newEmployeeData) throws InterruptedException {
// Получаем всех сотрудников из таблицы
        List<EmployeeEntity> existingEmployees = getEmployeesFromTable();
...
// Перебираем каждого сотрудника через цикл for с использованием индекса,чтобы найти сотрудника с задан.email
    ...
    public EmployeeWebTablesPage deleteEmployee(String email) {
        List<EmployeeEntity> existingEmployees = getEmployeesFromTable();
